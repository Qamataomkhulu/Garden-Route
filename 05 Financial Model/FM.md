...
```mermaid
flowchart LR
P1["Phase 1<br/>Pilot & Proof of Concept"]
--> P2["Phase 2<br/>Commercial Expansion"]
--> P3["Phase 3<br/>Regional AgriHub"]

style P1 fill:#1B5E20,color:#fff
style P2 fill:#2E7D32,color:#fff
style P3 fill:#388E3C,color:#fff
```
...
```mermaid
pie title Typical Annual Operating Costs
...
CEO --> Finance["Finance & Administration"]

CEO --> Sales["Sales & Marketing"]

Ops --> Farm["Farm Manager"]

Ops --> Water["Water Operations"]

Ops --> Solar["Energy Systems"]

Farm --> Workers["Farm Technicians"]

Water --> Operators["RO Plant Operators"]

Sales --> Logistics["Distribution Team"]

Finance --> Admin["Administration"]

style CEO fill:#1B5E20,color:#fff
```
...
title "Projected Employment Growth"

x-axis [Year1, Year2, Year3, Year4, Year5]

y-axis "Employees" 0 --> 35
...
y-axis "Revenue (Million Rand)" 0 --> 40

line [3.07,6.70,14.09,22.70,36.22]
```
