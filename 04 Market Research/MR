...
style Food fill:#2E7D32,color:#fff
style Revenue fill:#1B5E20,color:#fff
```
...
EC --> Coastal["Coastal Belt"]

EC --> Inland["Inland Plateau"]

EC --> Highlands["Mountain Regions"]

Coastal --> Horticulture["Vegetables • Citrus • Herbs"]

Inland --> Livestock["Livestock • Grain • Fodder"]

Highlands --> Forestry["Forestry • Water Catchments"]

style EC fill:#1B5E20,color:#fff
```
